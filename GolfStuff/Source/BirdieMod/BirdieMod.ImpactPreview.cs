...
public partial class BirdieMod
{
    ...
    private void CreateImpactPreviewHud(Transform parent)
    {
        ...
        impactPreviewPanelObject = new GameObject("BirdieImpactPreviewPanel");
        ...
        GameObject viewportObject = new GameObject("BirdieImpactPreviewViewport");
    ...
    private void EnsureImpactPreviewResources()
    {
            ...
            impactPreviewTexture.height != impactPreviewTextureHeight)
        {
            ...
            impactPreviewTexture.name = "BirdieImpactPreviewTexture";
        ...
        {
            impactPreviewCameraObject = new GameObject("BirdieImpactPreviewCamera");
